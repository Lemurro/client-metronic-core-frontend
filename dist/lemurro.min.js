...
var lemurro={};lemurro.start=function(){lemurro.router=new Navigo(location.protocol+"//"+location.host,app.config.router.useHash,app.config.router.hash),lemurro.router.on(app.routes.pages),lemurro.router.notFound(app.routes.notFound),lemurro.router.hooks({after:function(){app.started?lemurro._loadPage():lemurro.init()}}),lemurro.router.resolve()},lemurro.init=function(){lemurro.sessionID="",lemurro.userinfo={},lemurro.lightajax=new LightAjax({callbackAlert:function(e,r){swal(e,r,"error")},ajax:{beforeSend:function(e,r){/^(HEAD|OPTIONS|TRACE)$/i.test(r.type)||(e.setRequestHeader("X-SESSION-ID",lemurro.sessionID),e.setRequestHeader("X-UTC-OFFSET",moment().utcOffset()))}}}),$.fn.select2.defaults.set("language","ru"),$.fn.select2.defaults.set("placeholder","Выберите из списка"),lemurro._bindJSerrors(),lemurro._initAuthForm(),lemurro._t7helperDecimal(),lemurro._t7helperLocalTime(),localforage.getItem("sessionID",function(e,r){lemurro.sessionID=r,lemurro.auth.check()}),localforage.getItem("lastSessionID",function(e,r){null!==r&&$("#js-user-return").removeClass("d-none")})},lemurro._bindForAll=function(){lemurro.router.updatePageLinks(),lemurro._bindInputmask(),lemurro._bindSelect2(),lemurro._bindTableFilter(),lemurro._showElementsByRoles()},lemurro._bindInputmask=function(){$("#js-page").find(".js-mask").each(function(){var e=$(this);Inputmask({mask:e.attr("data-mask")}).mask(e)})},lemurro._bindJSerrors=function(){function e(e,r,t,s,o){var a="JSON not found";window.JSON&&(a=JSON.stringify(o)),"object"==typeof e&&(r=e.filename,t=e.lineno,s=e.colno,a=e.error.stack,e=e.message),(new Image).src=pathServerAPI+"jserrors?msg="+encodeURIComponent(e)+"&file="+encodeURIComponent(r)+"&line="+encodeURIComponent(t)+"&col="+encodeURIComponent(s)+"&err="+encodeURIComponent(a)}window.addEventListener?window.addEventListener("error",e,!1):window.attachEvent?window.attachEvent("onerror",e):window.onerror=e},lemurro._bindSelect2=function(){$("#js-page").find(".js-select2").each(function(){$(this).select2()})},lemurro._bindTableFilter=function(){$("#js-page").find(".tablefilter").TableFilter()},lemurro._initAuthForm=function(){var e=$("#js-auth"),r=$("#js-auth__get-form"),t=$("#js-auth__check-form"),s=app.config.auth.type;app.config.auth.strings.hasOwnProperty(s)||(s="mixed");var o=app.config.auth.strings[s];r.find(".js-auth__auth-id").html(o.getForm.inputLabel),t.find(".js-auth__auth-code").html(o.checkForm.inputLabel),t.find(".js-auth__repeat").html(o.checkForm.repeatMessage),r.find('input[name="auth_id"]').on("keyup",function(e){"Enter"===e.key&&(e.preventDefault(),lemurro.auth.getCode())}).addClass(o.getForm.inputClass),t.find('input[name="auth_code"]').on("keyup",function(e){"Enter"===e.key&&(e.preventDefault(),lemurro.auth.checkCode())}),e.find(".js-code-mask").each(function(){var e=$(this);Inputmask({mask:"9999"}).mask(e)}),e.find(".js-phone-mask").each(function(){var e=$(this);Inputmask({mask:"+7 (999) 999-99-99"}).mask(e)})},lemurro._loadPage=function(){var e=location.protocol+"//"+location.host+"/"+app.page.name+".html";document.title=app.page.title+" | "+app.config.title,$("header").find(".js-link").each(function(){var e=$(this);e.removeClass(e.attr("data-active-class"))}),$("#js-page").load(e,function(){$("header").find(".js-link__"+app.page.name).each(function(){var e=$(this);e.addClass(e.attr("data-active-class"))}),lemurro._bindForAll(),isEmpty(app.page.onLoad)||app.page.onLoad()})},lemurro._showElementsByRoles=function(){var e=$("body");if(lemurro.userinfo.admin)e.find(".js-role").removeClass("d-none");else for(var r in lemurro.userinfo.roles)if(lemurro.userinfo.roles.hasOwnProperty(r))for(var t in lemurro.userinfo.roles[r])if(lemurro.userinfo.roles[r].hasOwnProperty(t)){var s=lemurro.userinfo.roles[r][t];e.find(".js-role__"+r+"--"+s).removeClass("d-none")}},lemurro._t7helperDecimal=function(){Template7.registerHelper("lemurrodecimal",function(e,r){return lemurro.helper.decimal(e,r)})},lemurro._t7helperLocalTime=function(){Template7.registerHelper("lemurrolocaltime",function(e,r){return lemurro.helper.localTime(e,r)})},lemurro.authScreen=function(e){var r=$("#js-auth");"show"===e?(document.title=app.config.title,$("#js-auth__get-form").show(),$("#js-auth__check-form").hide(),r.find('input[type="text"]').val(""),r.modal({backdrop:"static",keyboard:!1})):r.modal("hide")},lemurro.showErrors=function(e){if(1===e.length&&"401 Unauthorized"===e[0].status)lemurro.authScreen("show");else if(1===e.length&&"403 Forbidden"===e[0].status){var r=!0;e[0].hasOwnProperty("meta")&&e[0].meta.hasOwnProperty("redirect")&&(r=e[0].meta.redirect),r?lemurro.router.navigate("/403"):lemurro._showError(e[0].code,e[0].title)}else for(var t in e)lemurro._showError(e[t].code,e[t].title)},lemurro._showError=function(e,r){var t="Неизвестная ошибка",s="error";switch(e){case"danger":s="error",t="Критическая ошибка";break;case"warning":s="warning",t="Внимание!";break;case"info":s="info",t="Информация"}swal(t,r,s)},lemurro.auth={},lemurro.auth._timerID=null,lemurro.auth._getUser=function(){lemurro.lightajax.get(!1,pathServerAPI+"user",{},function(e){e.hasOwnProperty("errors")?(lemurro.lightajax.preloader("hide"),lemurro.showErrors(e.errors)):(lemurro.lightajax.preloader("hide"),lemurro.userinfo=e.data,lemurro.auth._success())})},lemurro.auth._runTimer=function(){null!==lemurro.auth._timerID&&clearInterval(lemurro.auth._timerID),lemurro.auth._timerID=setInterval(function(){var e=$("#js-auth__check-form"),r=e.find(".js-timer__count"),t=parseInt(r.text(),10);t>0?r.text(--t):(clearInterval(lemurro.auth._timerID),e.find(".js-timer").hide(),e.find(".js-resend").show())},1e3)},lemurro.auth._success=function(){$(".js-user__auth-id").text(lemurro.userinfo.auth_id),app.started=!0,$("#js-preloader-overlay").hide(),app.init(lemurro._loadPage)},lemurro.auth.check=function(){lemurro.lightajax.get(!0,pathServerAPI+"auth/check",{},function(e){e.hasOwnProperty("errors")?(lemurro.lightajax.preloader("hide"),lemurro.showErrors(e.errors)):lemurro.auth._getUser()})},lemurro.auth.checkCode=function(){var e=bowser.getParser(window.navigator.userAgent),r=$("#js-auth__get-form").find('input[name="auth_id"]').val(),t=$("#js-auth__check-form").find('input[name="auth_code"]').val();return isEmpty(r)?void swal("Внимание!","Необходимо указать логин","warning"):isEmpty(t)?void swal("Внимание!","Необходимо указать код для входа","warning"):void lemurro.lightajax.post(!0,pathServerAPI+"auth/code",{auth_id:r,auth_code:t,device_info:{uuid:"WebApp",platform:e.parsedResult.os.name,version:e.parsedResult.os.version,manufacturer:e.parsedResult.browser.name,model:e.parsedResult.browser.version}},function(e){lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors")?($("#js-auth__check-form").find('input[name="auth_code"]').val(""),lemurro.showErrors(e.errors)):localforage.setItem("sessionID",e.data.session,function(){lemurro.sessionID=e.data.session,lemurro.authScreen("hide"),lemurro.auth.check()})})},lemurro.auth.getCode=function(){var e=$("#js-auth__get-form").find('input[name="auth_id"]').val();return isEmpty(e)?void swal("Внимание!","Необходимо указать логин","warning"):void lemurro.lightajax.get(!0,pathServerAPI+"auth/code",{auth_id:e},function(e){if(lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors"))lemurro.showErrors(e.errors);else{e.data.hasOwnProperty("message")&&console.log(e.data.message,"AuthCode");var r=$("#js-auth__check-form");r.find(".js-timer").show(),r.find(".js-timer__count").text("60"),r.find(".js-resend").hide(),lemurro.auth._runTimer(),$("#js-auth__get-form").hide(),r.show()}})},lemurro.auth.logout=function(){lemurro.helper.showConfirm("Выход","Вы действительно хотите выйти из системы?","Да","Нет",null,null,function(){$(".js-user-data").html('<i class="fas fa-spinner fa-pulse"></i>'),localforage.clear(),lemurro.sessionID="",lemurro.authScreen("show")},null)},lemurro.helper={},lemurro.helper.clearFields=function(e){e.find('input[type="text"],input[type="password"],input[type="email"],input[type="number"],input[type="tel"],input[type="url"],input[type="date"],input[type="time"]').val(""),e.find("textarea").val(""),e.find("select").each(function(){$(this).val(null).trigger("change")}),e.find('input[type="checkbox"]').each(function(){$(this).prop("checked",!1)}),e.find('input[type="radio"]').each(function(){$(this).prop("checked",!1)})},lemurro.helper.clearString=function(e){return e.length<13?e:e.split("").join("")},lemurro.helper.decimal=function(e,r){return void 0===e?0:(void 0!==r&&"number"==typeof r||(r=2),"number"==typeof e?parseFloat(e.toFixed(r)):(e=e.replace(/ /g,""),e=e.replace(/,/g,"."),e=parseFloat(e),isNaN(e)?0:parseFloat(e.toFixed(r))))},lemurro.helper.initBootstrapConfirmation=function(e,r){"undefined"==typeof r&&(r={});var t=Object.assign({title:"Вы уверены?",singleton:!0,popout:!0,rootSelector:"[data-toggle=confirmation]",btnOkLabel:"Да",btnOkClass:"btn btn-sm btn-success",btnCancelLabel:"Нет",btnCancelClass:"btn btn-sm btn-danger"},r);e.find(t.rootSelector).confirmation(t)},lemurro.helper.isRole=function(e,r,t,s){var o=setInterval(function(){if(lemurro.hasOwnProperty("userinfo"))if(clearInterval(o),lemurro.userinfo.admin)"function"==typeof t&&t();else{var a=!0;if(lemurro.userinfo.roles.hasOwnProperty(e)){var n;for(n in lemurro.userinfo.roles[e])lemurro.userinfo.roles[e][n]===r&&(a=!1,"function"==typeof t&&t())}a&&"function"==typeof s&&s()}},500)},lemurro.helper.localTime=function(e,r){return isEmpty(e)||isEmpty(r)?e:moment.utc(e).local().format(r)},lemurro.helper.showConfirm=function(e,r,t,s,o,a,n,i){swal({title:e,html:r,type:"question",buttonsStyling:!1,focusConfirm:!1,allowOutsideClick:!1,allowEscapeKey:!1,allowEnterKey:!1,showCancelButton:!0,confirmButtonText:t,cancelButtonText:s,confirmButtonClass:"btn btn-success",cancelButtonClass:"btn btn-danger",onOpen:o,preConfirm:a}).then(function(e){e.value?"function"==typeof n&&n():"function"==typeof i&&i()})},lemurro.tabs={},lemurro.tabs.showTab=function(e){var r=$("#js-tabs__links"),t=$("#js-tabs__contents");r.find(".nav-link").removeClass("active show"),t.find(".tab-pane").removeClass("active show"),r.find('a[data-target="#'+e+'"]').addClass("active show"),t.find("#"+e).addClass("active show")},lemurro.tabs.tabInsertEdit=function(e){var r=$("#js-tabs__links"),t=$("#js-tabs__contents");"show"===e?(r.find('a[data-target="#tab-form"]').parent().show(),t.find("#tab-form").addClass("active show"),lemurro.tabs.showTab("tab-form")):(r.find('a[data-target="#tab-form"]').parent().hide(),t.find("#tab-form").removeClass("active show"),lemurro.tabs.showTab("tab-list"))},lemurro.guide={},lemurro.guide.init=function(e,r){lemurro.guide._name=e,lemurro.guide._class=r,lemurro.guide._templates={},lemurro.guide._load()},lemurro.guide._getData=function(){lemurro.lightajax.get(!0,pathServerAPI+"guide/"+lemurro.guide._name,{},function(e){if(lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors"))lemurro.showErrors(e.errors);else{if($("#js-guide__loader").hide(),0===e.data.count)$("#js-guide__empty").show();else{var r=$("#js-guide__items"),t="";for(var s in e.data.items)e.data.items.hasOwnProperty(s)&&(t+=lemurro.guide._templates.item(e.data.items[s]));r.html(t),$("#js-guide__list").show(),lemurro.helper.initBootstrapConfirmation(r,null)}!isEmpty(lemurro.guide._class)&&window.hasOwnProperty(lemurro.guide._class)&&window[lemurro.guide._class].hasOwnProperty("init")&&window[lemurro.guide._class].init()}})},lemurro.guide._load=function(){var e=$("#js-page"),r=location.protocol+"//"+location.host+"/guide_"+lemurro.guide._name+".html";e.find(".js-guide__title").html(app.page.title),e.find(".js-guide-link").each(function(){var e=$(this);e.removeClass(e.attr("data-active-class"))}),e.find(".js-guide__content").load(r,function(){e.find(".js-guide-link__"+lemurro.guide._name).each(function(){var e=$(this);e.addClass(e.attr("data-active-class"))}),lemurro.guide._templates={item:Template7.compile($("#js-tpl-guide__item").html())},lemurro._bindForAll(),lemurro.guide._getData()})},lemurro.guide.edit=function(e,r){lemurro.lightajax.get(!0,pathServerAPI+"guide/"+lemurro.guide._name+"/"+e,{},function(t){if(lemurro.lightajax.preloader("hide"),t.hasOwnProperty("errors"))lemurro.showErrors(t.errors);else{var s=$("#js-guide-form");s.attr("data-id",e),s.find(".js-title").text("Редактирование записи"),$("#js-guide__button-insert").hide(),$("#js-guide__button-save").show(),$("#js-tab-form-button").html('<i class="fas fa-pencil-alt"></i> Редактировать'),lemurro.tabs.tabInsertEdit("show"),"function"==typeof r&&r(t)}})},lemurro.guide.insert=function(e,r){lemurro.lightajax.post(!0,pathServerAPI+"guide/"+lemurro.guide._name,{data:e},function(e){lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors")?lemurro.showErrors(e.errors):"function"==typeof r&&r(e)})},lemurro.guide.remove=function(e,r,t){lemurro.lightajax.post(!0,pathServerAPI+"guide/"+lemurro.guide._name+"/"+e+"/remove",{},function(e){lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors")?lemurro.showErrors(e.errors):"function"==typeof t&&t(e)})},lemurro.guide.save=function(e,r){lemurro.lightajax.post(!0,pathServerAPI+"guide/"+lemurro.guide._name+"/"+e.id,{data:e},function(e){lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors")?lemurro.showErrors(e.errors):"function"==typeof r&&r(e)})},lemurro.guide.showInsertForm=function(e){var r=$("#js-guide-form");r.attr("data-id","0"),r.find(".js-title").text("Добавление записи"),lemurro.helper.clearFields(r),$("#js-guide__button-insert").show(),$("#js-guide__button-save").hide(),$("#js-tab-form-button").html('<i class="fas fa-plus"></i> Добавить'),lemurro.tabs.tabInsertEdit("show"),"function"==typeof e&&e()},lemurro.users={},lemurro.users.init=function(){lemurro.users._t7helperAccessSets(),lemurro.users._templates={roles:Template7.compile($("#js-tpl-user__roles").html()),accessSetsItem:Template7.compile($("#js-tpl-access-sets__item").html()),accessSetsRoles:Template7.compile($("#js-tpl-access-sets__roles").html())},lemurro.users._initRoles(),users.init(),lemurro.accessSets.getData()},lemurro.users._initRoles=function(){var e=$("#js-user__roles"),r=app.config.userRoles,t={};for(var s in r.list)if(r.list.hasOwnProperty(s)){var o=r.list[s],a=[],n=o.title.replace(/"/g,"");t.hasOwnProperty(n)||(t[n]=[]);for(var i in o.access)if(o.access.hasOwnProperty(i)){var l=o.access[i],u=r.guideAccess.hasOwnProperty(l)?r.guideAccess[l]:"!unknown";t[n].push({roleName:o.name,accessCode:l,accessName:u.replace(/"/g,"")}),a.push({code:l,name:u})}e.append(lemurro.users._templates.roles({roleName:o.name,roleTitle:o.title,access:a}))}lemurro.users._setFilterListRoles(t),$("#js-access-sets__roles").html(e.html())},lemurro.users._setFilterListRoles=function(e){function r(e,r){var t=e.accessName.toUpperCase(),s=r.accessName.toUpperCase(),o=0;return t>s?o=1:t<s&&(o=-1),o}var t="",s={};Object.keys(e).sort().forEach(function(r){s[r]=e[r]});for(var o in s)if(s.hasOwnProperty(o)){var a=s[o];t+='<optgroup label="'+o+'">',a.sort(r);for(var n in a)a.hasOwnProperty(n)&&(t+='<option value="'+a[n].roleName+"|"+a[n].accessCode+'">'+o+": "+a[n].accessName+"</option>");t+="</optgroup>"}$("#js-page").find(".js-filter").find('select[name="lemurro_roles"]').append(t)},lemurro.users._t7helperAccessSets=function(){Template7.registerHelper("lemurroaccesssets",function(e){var r=[],t={};for(var s in app.config.userRoles.list)if(app.config.userRoles.list.hasOwnProperty(s)){var o=app.config.userRoles.list[s];t[o.name]=o.title}for(var a in e)if(e.hasOwnProperty(a)){var n=e[a],i=[];for(var l in n)n.hasOwnProperty(l)&&app.config.userRoles.guideAccess.hasOwnProperty(n[l])&&i.push(app.config.userRoles.guideAccess[n[l]]);r.push({title:t.hasOwnProperty(a)?t[a]:"!неизвестно>>"+a,access:i})}return lemurro.users._templates.accessSetsRoles(r)})},lemurro.users.applyFilter=function(){var e=$("#js-page"),r={};e.find(".js-filter").find(".js-filter__element").each(function(){var e=$(this),t=e.attr("name");r[t]=e.val()}),e.find(".js-message__default").hide(),e.find(".js-message__notfound").hide(),lemurro.lightajax.post(!0,pathServerAPI+"users/filter",{data:r},function(r){lemurro.lightajax.preloader("hide"),r.hasOwnProperty("errors")?lemurro.showErrors(r.errors):(lemurro.users.showData(r.data),0===r.data.count&&e.find(".js-message__notfound").show())})},lemurro.users.clearFilter=function(){var e=$("#js-page").find(".js-filter");e.find("select").val("all").trigger("change"),e.find('input[type="text"]').val("")},lemurro.users.edit=function(e,r){lemurro.lightajax.get(!0,pathServerAPI+"users/"+e,{},function(t){if(lemurro.lightajax.preloader("hide"),t.hasOwnProperty("errors"))lemurro.showErrors(t.errors);else{var s=$("#js-user-form");s.attr("data-id",e),s.find(".js-title").text("Редактирование пользователя"),"1"===e?(s.find(".js-user-id-1").prop("disabled",!0),swal("Внимание!","У данного пользователя некоторые поля запрещены к изменению","warning")):s.find(".js-user-id-1").prop("disabled",!1),$("#js-user__access-sets").find("select").val(null),$("#js-user__button-insert").hide(),$("#js-user__button-save").show(),$("#js-tab-form-button").html('<i class="fas fa-pencil-alt"></i> Редактировать'),lemurro.tabs.tabInsertEdit("show"),"function"==typeof r&&r(t)}})},lemurro.users.getData=function(){lemurro.lightajax.get(!0,pathServerAPI+"users",{},function(e){lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors")?lemurro.showErrors(e.errors):(lemurro.users.showData(e.data),localforage.getItem("lastSessionID",function(e,r){null!==r&&$("#js-users__items").find(".js-login-by-user").hide()}))})},lemurro.users.getRoles=function(e){var r={};return e.find(".js-role:checked").each(function(){var e=$(this),t=e.attr("data-role");"admin"===t?r.admin=!0:(r.hasOwnProperty(t)||(r[t]=[]),r[t].push(e.attr("data-access")))}),r.hasOwnProperty("admin")&&(r={admin:!0}),r},lemurro.users.insert=function(e,r){lemurro.lightajax.post(!0,pathServerAPI+"users",{data:e},function(e){lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors")?lemurro.showErrors(e.errors):"function"==typeof r&&r(e)})},lemurro.users.lock=function(e,r){"1"===e?swal("Внимание!","Блокировка пользователя с id=1 запрещена","warning"):lemurro.lightajax.post(!0,pathServerAPI+"users/"+e+"/lock",{},function(e){if(lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors"))lemurro.showErrors(e.errors);else{var t=$(users.templates.item(e.data)),s=$("#js-users__items").find('tr[data-item-id="'+e.data.id+'"]');s.html(t.html()),lemurro.helper.initBootstrapConfirmation(s,null),"function"==typeof r&&r(e)}})},lemurro.users.loginByUser=function(e){"1"===e?swal("Внимание!","Входить под пользователем с id=1 запрещено","warning"):lemurro.lightajax.post(!0,pathServerAPI+"users/login_by_user",{user_id:e},function(e){lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors")?lemurro.showErrors(e.errors):localforage.setItem("lastSessionID",lemurro.sessionID,function(){localforage.setItem("sessionID",e.data.session,function(){location.replace(location.origin)})})})},lemurro.users.remove=function(e,r,t){"1"===e?swal("Внимание!","Пользователь с id=1 не может быть удалён","warning"):lemurro.lightajax.post(!0,pathServerAPI+"users/"+e+"/remove",{},function(e){lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors")?lemurro.showErrors(e.errors):"function"==typeof t&&t(e)})},lemurro.users["return"]=function(){localforage.getItem("lastSessionID",function(e,r){var t=r;return null===t?void swal("Ошибка","Прошлая сессия отсутствует","error"):void swal({title:"Вернуться обратно?",html:"",type:"warning",showCancelButton:!0,confirmButtonText:"Да",cancelButtonText:"Нет"}).then(function(e){e.value&&localforage.removeItem("lastSessionID",function(){localforage.setItem("sessionID",t,function(){location.reload()})})})})},lemurro.users.save=function(e,r){lemurro.lightajax.post(!0,pathServerAPI+"users/"+e.id,{data:e},function(e){lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors")?lemurro.showErrors(e.errors):"function"==typeof r&&r(e)})},lemurro.users.setRoles=function(e,r){e.find(".js-role").prop("checked",!1);for(var t in r)if("admin"===t)e.find('.js-role[data-role="admin"]').prop("checked",!0);else for(var s in r[t])r[t].hasOwnProperty(s)&&e.find('.js-role[data-role="'+t+'"][data-access="'+r[t][s]+'"]').prop("checked",!0)},lemurro.users.showData=function(e){var r=$("#js-users__items"),t="";for(var s in e.items)e.items.hasOwnProperty(s)&&(t+=users.templates.item(e.items[s]));r.html(t),lemurro.helper.initBootstrapConfirmation(r,null)},lemurro.users.showInsertForm=function(e){var r=$("#js-user-form");r.attr("data-id","0"),r.find(".js-title").text("Добавление пользователя"),lemurro.helper.clearFields(r),r.find(".js-user-id-1").prop("disabled",!1),$("#js-user__access-sets").find("select").val(null),$("#js-user__button-insert").show(),$("#js-user__button-save").hide(),$("#js-tab-form-button").html('<i class="fas fa-plus"></i> Добавить'),lemurro.tabs.tabInsertEdit("show"),"function"==typeof e&&e()},lemurro.users.toggleFilter=function(){var e=$("#js-page"),r=e.find(".js-filter__angle"),t=e.find(".js-filter"),s=t.attr("data-visible");"0"===s?(t.attr("data-visible","1").show(),r.removeClass("fa-angle-down").addClass("fa-angle-up")):(t.attr("data-visible","0").hide(),r.removeClass("fa-angle-up").addClass("fa-angle-down"))},lemurro.users.unlock=function(e,r){lemurro.lightajax.post(!0,pathServerAPI+"users/"+e+"/unlock",{},function(e){if(lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors"))lemurro.showErrors(e.errors);else{var t=$(users.templates.item(e.data)),s=$("#js-users__items").find('tr[data-item-id="'+e.data.id+'"]');s.html(t.html()),lemurro.helper.initBootstrapConfirmation(s,null),"function"==typeof r&&r(e)}})},lemurro.accessSets={},lemurro.accessSets._buildSelect=function(){var e=$("#js-user__access-sets"),r="";$("#js-access-sets__items").find("tr").each(function(){var e=$(this),t=e.attr("data-item-id"),s=e.find(".name").text();r+='<option value="'+t+'">'+s+"</option>"}),e.find("select").html(r),notEmpty(r)?e.show():e.hide()},lemurro.accessSets._collectData=function(){var e=$("#js-access-sets-form");return e.valid()?{id:e.attr("data-id"),name:e.find('input[name="name"]').val(),roles:lemurro.users.getRoles(e)}:(swal("Внимание!","Заполните все поля, помеченные красным","warning"),{})},lemurro.accessSets.apply=function(){var e=$("#js-user__access-sets").find("select"),r=e.val();isEmpty(r)||lemurro.lightajax.get(!0,pathServerAPI+"access_sets/"+r,{},function(r){lemurro.lightajax.preloader("hide"),r.hasOwnProperty("errors")?lemurro.showErrors(r.errors):(lemurro.users.setRoles($("#js-user-form"),r.data.roles),e.val(null),swal("Выполнено",'Успешно применён набор "'+r.data.name+'"',"success"))})},lemurro.accessSets.closeForm=function(){$("#js-access-sets-form").hide(),$("#js-access-sets__button-add").show()},lemurro.accessSets.edit=function(e){lemurro.lightajax.get(!0,pathServerAPI+"access_sets/"+e,{},function(r){if(lemurro.lightajax.preloader("hide"),r.hasOwnProperty("errors"))lemurro.showErrors(r.errors);else{var t=$("#js-access-sets-form");t.attr("data-id",e),t.find(".js-title").text("Редактирование набора"),t.find('input[name="name"]').val(r.data.name),$("#js-access-sets__button-insert").hide(),$("#js-access-sets__button-save").show(),$("#js-access-sets__button-add").hide(),lemurro.users.setRoles(t,r.data.roles),t.show()}})},lemurro.accessSets.getData=function(){lemurro.lightajax.get(!1,pathServerAPI+"access_sets",{},function(e){if(e.hasOwnProperty("errors"))lemurro.showErrors(e.errors);else{var r=$("#js-access-sets__items"),t="";for(var s in e.data.items)if(e.data.items.hasOwnProperty(s)){var o=e.data.items[s];t+=lemurro.users._templates.accessSetsItem(o)}r.html(t),lemurro.helper.initBootstrapConfirmation(r,null),lemurro.accessSets._buildSelect()}})},lemurro.accessSets.insert=function(){var e=lemurro.accessSets._collectData();Object.keys(e).length>0&&lemurro.lightajax.post(!0,pathServerAPI+"access_sets",{data:e},function(e){if(lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors"))lemurro.showErrors(e.errors);else{var r=$("#js-access-sets__items");r.prepend(lemurro.users._templates.accessSetsItem(e.data));var t=r.find('tr[data-item-id="'+e.data.id+'"]');lemurro.helper.initBootstrapConfirmation(t,null),lemurro.accessSets._buildSelect(),$("#js-access-sets-form").hide(),$("#js-access-sets__button-add").show()}})},lemurro.accessSets.remove=function(e){lemurro.lightajax.post(!0,pathServerAPI+"access_sets/"+e+"/remove",{},function(e){lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors")?lemurro.showErrors(e.errors):($("#js-access-sets__items").find('tr[data-item-id="'+e.data.id+'"]').remove(),lemurro.accessSets._buildSelect(),swal("Выполнено","Запись успешно удалена","success"))})},lemurro.accessSets.save=function(){var e=lemurro.accessSets._collectData();Object.keys(e).length>0&&lemurro.lightajax.post(!0,pathServerAPI+"access_sets/"+e.id,{data:e},function(e){if(lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors"))lemurro.showErrors(e.errors);else{var r=$(lemurro.users._templates.accessSetsItem(e.data)),t=$("#js-access-sets__items").find('tr[data-item-id="'+e.data.id+'"]');t.html(r.html()),lemurro.helper.initBootstrapConfirmation(t,null),lemurro.accessSets._buildSelect(),$("#js-access-sets-form").hide(),$("#js-access-sets__button-add").show(),swal("Выполнено","Запись успешно изменена","success")}})},lemurro.accessSets.showInsertForm=function(){var e=$("#js-access-sets-form");e.attr("data-id","0"),e.find(".js-title").text("Добавление набора"),lemurro.helper.clearFields(e),$("#js-access-sets__button-insert").show(),$("#js-access-sets__button-save").hide(),$("#js-access-sets__button-add").hide(),e.show()},lemurro.file={},lemurro.file.init=function(e){lemurro.file._config(),isEmpty(e)?lemurro.file._classFile="js-files__file":lemurro.file._classFile=e},lemurro.file._config=function(){ss.uploadSetup({url:pathServerAPI+"file/upload",name:"uploadfile",hoverClass:"hover",focusClass:"focus",responseType:"json",multiple:!0,multipleSelect:!0,customHeaders:{"X-SESSION-ID":lemurro.sessionID,"X-UTC-OFFSET":moment().utcOffset()}})},lemurro.file.bindUpload=function(e,r,t){var s=e.html();isEmpty(t)&&(t={});var o=$.extend({button:e,onSubmit:function(){e.html('<i class="fas fa-spinner fa-pulse"></i> Загрузка...').prop("disabled",!0)},onComplete:function(t,o){return e.html(s).prop("disabled",!1),o?void(o.hasOwnProperty("errors")?lemurro.showErrors(o.errors):"function"==typeof r?r(o.data.id,"add",t,e):swal("Выполнено","Файл <strong>"+t+"</strong> успешно загружен","success")):(swal("Произошла ошибка",'Не удалось загрузить файл "'+t+'", попробуйте ещё раз',"error"),!1)},onError:function(r){e.html(s).prop("disabled",!1),swal("Произошла ошибка",'Не удалось загрузить файл "'+r+'", попробуйте ещё раз',"error")}},t);new ss.SimpleUpload(o)},lemurro.file.download=function(e,r){lemurro.lightajax.post(!0,pathServerAPI+"file/download/prepare",{fileid:e,filename:r},function(e){lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors")?lemurro.showErrors(e.errors):window.open(pathServerAPI+"file/download/run?token="+encodeURI(e.data.token),"Download file")})},lemurro.file.remove=function(e,r){var t=$("."+lemurro.file._classFile+'[data-file-id="'+e+'"]'),s=t.find(".js-name").text();swal({title:"Удаление файла",html:'Вы хотите удалить файл "'+s+'"?',type:"warning",showCancelButton:!0,confirmButtonText:"Да, удалить!",cancelButtonText:"Отмена"}).then(function(o){o.value&&("add"===t.attr("data-file-action")?t.remove():t.attr("data-file-action","remove").hide(),isEmpty(r)||r(e,s))})};