...
!function(){function e(e){if(null===e)return!0;var n=typeof e;switch(n){case"undefined":return!0;case"number":return isNaN(e);case"string":return""===e.trim();case"object":var t=Object.keys(e).length;return t<1;case"function":case"boolean":return!1;default:return console.log('Unknown value type: "'+n+'"',"isEmpty.js"),!1}}window.hasOwnProperty("isEmpty")||(window.isEmpty=e)}();
...
lemurro.auth={},lemurro.auth._timerID=null,lemurro.auth._getUser=function(){lemurro.lightajax.get(!1,pathServerAPI+"user",{},function(e){e.hasOwnProperty("errors")?(lemurro.lightajax.preloader("hide"),lemurro.showErrors(e.errors)):(lemurro.lightajax.preloader("hide"),lemurro.userinfo=e.data,lemurro.auth._success())})},lemurro.auth._runTimer=function(){null!==lemurro.auth._timerID&&clearInterval(lemurro.auth._timerID),lemurro.auth._timerID=setInterval(function(){var e=$("#js-auth__check-form"),r=e.find(".js-timer__count"),o=parseInt(r.text(),10);o>0?r.text(--o):(clearInterval(lemurro.auth._timerID),e.find(".js-timer").hide(),e.find(".js-resend").show())},1e3)},lemurro.auth._success=function(){var e=$("body");if($(".js-user__auth-id").text(lemurro.userinfo.auth_id),lemurro.userinfo.admin)e.find(".js-role").removeClass("d-none");else for(var r in lemurro.userinfo.roles)if(lemurro.userinfo.roles.hasOwnProperty(r))for(var o in lemurro.userinfo.roles[r])if(lemurro.userinfo.roles[r].hasOwnProperty(o)){var t=lemurro.userinfo.roles[r][o];e.find(".js-role__"+r+"--"+t).removeClass("d-none")}app.started=!0,$("#js-preloader-overlay").hide(),app.init(),lemurro._loadPage()},lemurro.auth.check=function(){lemurro.lightajax.get(!0,pathServerAPI+"auth/check",{},function(e){e.hasOwnProperty("errors")?(lemurro.lightajax.preloader("hide"),lemurro.showErrors(e.errors)):lemurro.auth._getUser()})},lemurro.auth.checkCode=function(){var e=bowser.getParser(window.navigator.userAgent);lemurro.lightajax.post(!0,pathServerAPI+"auth/code",{auth_id:$("#js-auth__get-form").find('input[name="auth_id"]').val(),auth_code:$("#js-auth__check-form").find('input[name="auth_code"]').val(),device_info:{uuid:"WebApp",platform:e.parsedResult.os.name,version:e.parsedResult.os.version,manufacturer:e.parsedResult.browser.name,model:e.parsedResult.browser.version}},function(e){lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors")?($("#js-auth__check-form").find('input[name="auth_code"]').val(""),lemurro.showErrors(e.errors)):localforage.setItem("sessionID",e.data.session,function(){lemurro.sessionID=e.data.session,lemurro.authScreen("hide"),lemurro.auth.check()})})},lemurro.auth.getCode=function(){lemurro.lightajax.get(!0,pathServerAPI+"auth/code",{auth_id:$("#js-auth__get-form").find('input[name="auth_id"]').val()},function(e){if(lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors"))lemurro.showErrors(e.errors);else{e.data.hasOwnProperty("message")&&console.log(e.data.message,"AuthCode");var r=$("#js-auth__check-form");r.find(".js-timer").show(),r.find(".js-timer__count").text("60"),r.find(".js-resend").hide(),lemurro.auth._runTimer(),$("#js-auth__get-form").hide(),r.show()}})},lemurro.auth.logout=function(){lemurro.helper.showConfirm("Выход","Вы действительно хотите выйти из системы?","Да","Нет",null,null,function(){$(".js-user-data").html('<i class="fas fa-spinner fa-pulse"></i>'),localforage.clear(),lemurro.sessionID="",lemurro.authScreen("show")},null)};var lemurro={};lemurro.start=function(){lemurro.router=new Navigo(location.protocol+"//"+location.host,app.config.router.useHash,app.config.router.hash),lemurro.router.on(app.routes.pages),lemurro.router.notFound(app.routes.notFound),lemurro.router.hooks({after:function(){app.started?lemurro._loadPage():lemurro.init()}}),lemurro.router.resolve()},lemurro.init=function(){lemurro.sessionID="",lemurro.userinfo={},lemurro.lightajax=new LightAjax({callbackAlert:function(e,r){swal(e,r,"error")},ajax:{beforeSend:function(e,r){/^(HEAD|OPTIONS|TRACE)$/i.test(r.type)||(e.setRequestHeader("X-SESSION-ID",lemurro.sessionID),e.setRequestHeader("X-UTC-OFFSET",moment().utcOffset()))}}}),lemurro._bindJSerrors(),lemurro._initAuthForm(),lemurro._t7helperDecimal(),lemurro._t7helperLocalTime(),localforage.getItem("sessionID",function(e,r){lemurro.sessionID=r,lemurro.auth.check()}),localforage.getItem("lastSessionID",function(e,r){null!==r&&$("#js-user-return").removeClass("d-none")})},lemurro._bindForAll=function(){lemurro.router.updatePageLinks(),lemurro._bindInputmask(),lemurro._bindSelect2(),lemurro._bindTableFilter()},lemurro._bindInputmask=function(){$("#js-page").find(".js-mask").each(function(){var e=$(this);Inputmask({mask:e.attr("data-mask")}).mask(e)})},lemurro._bindJSerrors=function(){function e(e,r,o,t,a){var s="JSON not found";window.JSON&&(s=JSON.stringify(a)),"object"==typeof e&&(r=e.filename,o=e.lineno,t=e.colno,s=e.error.stack,e=e.message),(new Image).src=pathServerAPI+"jserrors?msg="+encodeURIComponent(e)+"&file="+encodeURIComponent(r)+"&line="+encodeURIComponent(o)+"&col="+encodeURIComponent(t)+"&err="+encodeURIComponent(s)}window.addEventListener?window.addEventListener("error",e,!1):window.attachEvent?window.attachEvent("onerror",e):window.onerror=e},lemurro._bindSelect2=function(){$("#js-page").find(".js-select2").each(function(){$(this).select2({language:"ru",placeholder:"Выберите из списка"})})},lemurro._bindTableFilter=function(){$("#js-page").find(".tablefilter").TableFilter()},lemurro._initAuthForm=function(){var e=$("#js-auth"),r=$("#js-auth__get-form"),o=$("#js-auth__check-form"),t=app.config.auth.type,a=app.config.auth.strings[t];r.find(".js-auth__auth-id").html(a.getForm.inputLabel),r.find('input[name="auth_id"]').addClass(a.getForm.inputClass),o.find(".js-auth__auth-code").html(a.checkForm.inputLabel),o.find(".js-auth__repeat").html(a.checkForm.repeatMessage),e.find(".js-code-mask").each(function(){var e=$(this);Inputmask({mask:"9999"}).mask(e)}),e.find(".js-phone-mask").each(function(){var e=$(this);Inputmask({mask:"+7 (999) 999-99-99"}).mask(e)})},lemurro._loadPage=function(){var e=location.protocol+"//"+location.host+"/"+app.page.name+".html";document.title=app.page.title+" | "+app.config.title,$("header").find(".js-link").each(function(){var e=$(this);e.removeClass(e.attr("data-active-class"))}),$("#js-page").load(e,function(){$("header").find(".js-link__"+app.page.name).each(function(){var e=$(this);e.addClass(e.attr("data-active-class"))}),lemurro._bindForAll(),isEmpty(app.page.onLoad)||app.page.onLoad()})},lemurro._t7helperDecimal=function(){Template7.registerHelper("lemurrodecimal",function(e,r){return lemurro.helper.decimal(e,r)})},lemurro._t7helperLocalTime=function(){Template7.registerHelper("lemurrolocaltime",function(e,r){return lemurro.helper.localTime(e,r)})},lemurro.authScreen=function(e){var r=$("#js-auth");"show"===e?(document.title=app.config.title,$("#js-auth__get-form").show(),$("#js-auth__check-form").hide(),r.find('input[type="text"]').val(""),r.modal({backdrop:"static",keyboard:!1})):r.modal("hide")},lemurro.showErrors=function(e){if(1===e.length&&"401 Unauthorized"===e[0].status)lemurro.authScreen("show");else if(1===e.length&&"403 Forbidden"===e[0].status){var r=!0;e[0].hasOwnProperty("meta")&&e[0].meta.hasOwnProperty("redirect")&&(r=e[0].meta.redirect),r?lemurro.router.navigate("/403"):lemurro._showError(e[0].code,e[0].title)}else for(var o in e)lemurro._showError(e[o].code,e[o].title)},lemurro._showError=function(e,r){var o="Неизвестная ошибка",t="error";switch(e){case"danger":t="error",o="Критическая ошибка";break;case"warning":t="warning",o="Внимание!";break;case"info":t="info",o="Информация"}swal(o,r,t)},lemurro.helper={},lemurro.helper.clearFields=function(e){e.find('input[type="text"],input[type="password"],input[type="email"],input[type="number"],input[type="tel"],input[type="url"],input[type="date"],input[type="time"]').val(""),e.find("textarea").val(""),e.find("select").each(function(){$(this).val(null).trigger("change")}),e.find('input[type="checkbox"]').each(function(){$(this).prop("checked",!1)}),e.find('input[type="radio"]').each(function(){$(this).prop("checked",!1)})},lemurro.helper.decimal=function(e,r){return void 0===e?0:(void 0!==r&&"number"==typeof r||(r=2),"number"==typeof e?parseFloat(e.toFixed(r)):(e=e.replace(/ /g,""),e=e.replace(/,/g,"."),e=parseFloat(e),isNaN(e)?0:parseFloat(e.toFixed(r))))},lemurro.helper.isRole=function(e,r,o,t){var a=setInterval(function(){if(lemurro.hasOwnProperty("userinfo"))if(clearInterval(a),lemurro.userinfo.admin)isEmpty(o)||o();else{var s=!0;if(lemurro.userinfo.roles.hasOwnProperty(e)){var n;for(n in lemurro.userinfo.roles[e])lemurro.userinfo.roles[e][n]===r&&(s=!1,isEmpty(o)||o())}s&&!isEmpty(t)&&t()}},500)},lemurro.helper.localTime=function(e,r){return isEmpty(e)||isEmpty(r)?e:moment.utc(e).local().format(r)},lemurro.helper.showConfirm=function(e,r,o,t,a,s,n,i){swal({title:e,html:r,type:"",allowOutsideClick:!1,showCancelButton:!0,confirmButtonText:o,cancelButtonText:t,onOpen:a,preConfirm:s}).then(function(e){e.value?n():null!==i&&i()})},lemurro.guide={},lemurro.guide.init=function(e,r){lemurro.guide._name=e,lemurro.guide._class=r,lemurro.guide._templates={},lemurro.guide._load()},lemurro.guide._getData=function(){lemurro.lightajax.get(!0,pathServerAPI+"guide/"+lemurro.guide._name,{},function(e){if(lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors"))lemurro.showErrors(e.errors);else{if($("#js-guide__loader").hide(),0===e.data.count)$("#js-guide__empty").show();else{var r="";for(var o in e.data.items)r+=lemurro.guide._templates.item(e.data.items[o]);$("#js-guide__items").html(r),$("#js-guide__list").show()}!isEmpty(lemurro.guide._class)&&window.hasOwnProperty(lemurro.guide._class)&&window[lemurro.guide._class].hasOwnProperty("init")&&window[lemurro.guide._class].init()}})},lemurro.guide._load=function(){var e=$("#js-page"),r=location.protocol+"//"+location.host+"/guide_"+lemurro.guide._name+".html";e.find(".js-guide__title").html(app.page.title),e.find(".js-guide-link").each(function(){var e=$(this);e.removeClass(e.attr("data-active-class"))}),e.find(".js-guide__content").load(r,function(){e.find(".js-guide-link__"+lemurro.guide._name).each(function(){var e=$(this);e.addClass(e.attr("data-active-class"))}),lemurro.guide._templates={item:Template7.compile($("#js-tpl-guide__item").html())},lemurro._bindForAll(),lemurro.guide._getData()})},lemurro.guide.edit=function(e,r){lemurro.lightajax.get(!0,pathServerAPI+"guide/"+lemurro.guide._name+"/"+e,{},function(o){if(lemurro.lightajax.preloader("hide"),o.hasOwnProperty("errors"))lemurro.showErrors(o.errors);else{var t=$("#js-guide-form");t.attr("data-id",e),t.find(".js-title").text("Редактирование записи"),$("#js-guide__button-insert").hide(),$("#js-guide__button-save").show(),$("#js-tab-form-button").html('<i class="fas fa-pencil-alt"></i> Редактировать'),lemurro.tabs.tabInsertEdit("show"),r(o)}})},lemurro.guide.insert=function(e,r){lemurro.lightajax.post(!0,pathServerAPI+"guide/"+lemurro.guide._name,{data:e},function(e){lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors")?lemurro.showErrors(e.errors):r(e)})},lemurro.guide.remove=function(e,r,o){swal({title:"Удаление записи",html:'Вы хотите удалить <strong>"'+r+'"</strong>?',type:"warning",showCancelButton:!0,confirmButtonText:"Да, удалить!",cancelButtonText:"Отмена"}).then(function(r){r.value&&lemurro.lightajax.post(!0,pathServerAPI+"guide/"+lemurro.guide._name+"/"+e+"/remove",{},function(e){lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors")?lemurro.showErrors(e.errors):o(e)})})},lemurro.guide.save=function(e,r){lemurro.lightajax.post(!0,pathServerAPI+"guide/"+lemurro.guide._name+"/"+e.id,{data:e},function(e){lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors")?lemurro.showErrors(e.errors):r(e)})},lemurro.guide.showInsertForm=function(e){var r=$("#js-guide-form");r.attr("data-id","0"),r.find(".js-title").text("Добавление записи"),lemurro.helper.clearFields(r),$("#js-guide__button-insert").show(),$("#js-guide__button-save").hide(),$("#js-tab-form-button").html('<i class="fas fa-plus"></i> Добавить'),lemurro.tabs.tabInsertEdit("show"),e()},lemurro.tabs={},lemurro.tabs.showTab=function(e){var r=$("#js-tabs__links"),o=$("#js-tabs__contents");r.find(".nav-link").removeClass("active show"),o.find(".tab-pane").removeClass("active show"),r.find('a[data-target="#'+e+'"]').addClass("active show"),o.find("#"+e).addClass("active show")},lemurro.tabs.tabInsertEdit=function(e){var r=$("#js-tabs__links"),o=$("#js-tabs__contents");"show"===e?(r.find('a[data-target="#tab-form"]').parent().show(),o.find("#tab-form").addClass("active show"),lemurro.tabs.showTab("tab-form")):(r.find('a[data-target="#tab-form"]').parent().hide(),o.find("#tab-form").removeClass("active show"),lemurro.tabs.showTab("tab-list"))},lemurro.users={},lemurro.users.init=function(){lemurro.users._templates={roles:Template7.compile($("#js-tpl-user__roles").html())},lemurro.users._initRoles(),users.init()},lemurro.users._initRoles=function(){var e=$("#js-user__roles"),r=app.config.userRoles;for(var o in r.list){var t=r.list[o],a=[];for(var s in t.access){var n=t.access[s],i=r.guideAccess.hasOwnProperty(n)?r.guideAccess[n]:"!unknown";a.push({code:n,name:i})}e.append(lemurro.users._templates.roles({roleName:t.name,roleTitle:t.title,access:a}))}},lemurro.users.edit=function(e,r){lemurro.lightajax.get(!0,pathServerAPI+"users/"+e,{},function(o){if(lemurro.lightajax.preloader("hide"),o.hasOwnProperty("errors"))lemurro.showErrors(o.errors);else{var t=$("#js-user-form");t.attr("data-id",e),t.find(".js-title").text("Редактирование пользователя"),$("#js-user__button-insert").hide(),$("#js-user__button-save").show(),$("#js-tab-form-button").html('<i class="fas fa-pencil-alt"></i> Редактировать'),lemurro.tabs.tabInsertEdit("show"),r(o)}})},lemurro.users.getData=function(){lemurro.lightajax.get(!0,pathServerAPI+"users",{},function(e){if(lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors"))lemurro.showErrors(e.errors);else{var r="";for(var o in e.data.items)r+=users.templates.item(e.data.items[o]);$("#js-users__items").html(r),localforage.getItem("lastSessionID",function(e,r){null!==r&&$("#js-users__items").find(".js-login-by-user").hide()})}})},lemurro.users.getRoles=function(e){var r={};return e.find(".js-role:checked").each(function(){var e=$(this),o=e.attr("data-role");"admin"===o?r.admin=!0:(r.hasOwnProperty(o)||(r[o]=[]),r[o].push(e.attr("data-access")))}),r.hasOwnProperty("admin")&&(r={admin:!0}),r},lemurro.users.insert=function(e,r){lemurro.lightajax.post(!0,pathServerAPI+"users",{data:e},function(e){lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors")?lemurro.showErrors(e.errors):r(e)})},lemurro.users.loginByUser=function(e){swal({title:"Войти под пользователем?",html:"",type:"warning",showCancelButton:!0,confirmButtonText:"Да",cancelButtonText:"Нет"}).then(function(r){r.value&&lemurro.lightajax.post(!0,pathServerAPI+"users/login_by_user",{user_id:e},function(e){lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors")?lemurro.showErrors(e.errors):localforage.setItem("lastSessionID",lemurro.sessionID,function(){localforage.setItem("sessionID",e.data.session,function(){location.replace(location.origin)})})})})},lemurro.users.remove=function(e,r,o){swal({title:"Удаление пользователя",html:'Вы хотите удалить <strong>"'+r+'"</strong>?',type:"warning",showCancelButton:!0,confirmButtonText:"Да, удалить!",cancelButtonText:"Отмена"}).then(function(r){r.value&&lemurro.lightajax.post(!0,pathServerAPI+"users/"+e+"/remove",{},function(e){lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors")?lemurro.showErrors(e.errors):o(e)})})},lemurro.users["return"]=function(){localforage.getItem("lastSessionID",function(e,r){var o=r;return null===o?void swal("Ошибка","Прошлая сессия отсутствует","error"):void swal({title:"Вернуться обратно?",html:"",type:"warning",showCancelButton:!0,confirmButtonText:"Да",cancelButtonText:"Нет"}).then(function(e){e.value&&localforage.removeItem("lastSessionID",function(){localforage.setItem("sessionID",o,function(){location.replace(location.origin)})})})})},lemurro.users.save=function(e,r){lemurro.lightajax.post(!0,pathServerAPI+"users/"+e.id,{data:e},function(e){lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors")?lemurro.showErrors(e.errors):r(e)})},lemurro.users.setRoles=function(e,r){e.find(".js-role").prop("checked",!1);for(var o in r)if("admin"===o)e.find('.js-role[data-role="admin"]').prop("checked",!0);else for(var t in r[o])e.find('.js-role[data-role="'+o+'"][data-access="'+r[o][t]+'"]').prop("checked",!0)},lemurro.users.showInsertForm=function(e){var r=$("#js-user-form");r.attr("data-id","0"),r.find(".js-title").text("Добавление пользователя"),lemurro.helper.clearFields(r),$("#js-user__button-insert").show(),$("#js-user__button-save").hide(),$("#js-tab-form-button").html('<i class="fas fa-plus"></i> Добавить'),lemurro.tabs.tabInsertEdit("show"),e()},lemurro.file={},lemurro.file.init=function(e){lemurro.file._config(),isEmpty(e)?lemurro.file._classFile="js-files__file":lemurro.file._classFile=e},lemurro.file._config=function(){ss.uploadSetup({name:"uploadfile",multiple:!0,multipleSelect:!0,multipart:!0,hoverClass:"hover",focusClass:"focus",responseType:"json",customHeaders:{"X-SESSION-ID":lemurro.sessionID,"X-UTC-OFFSET":moment().utcOffset()}})},lemurro.file.bindUpload=function(e,r){var o=e.html();new ss.SimpleUpload({button:e,url:pathServerAPI+"file/upload",onSubmit:function(){e.html('<i class="fas fa-spinner fa-pulse"></i> Загрузка...').prop("disabled",!0)},onComplete:function(t,a){return e.html(o).prop("disabled",!1),a?void(a.hasOwnProperty("errors")?lemurro.showErrors(a.errors):(isEmpty(r)||r(a.data.id,"add",t),swal("Выполнено","Файл <strong>"+t+"</strong> успешно загружен","success"))):(swal("Произошла ошибка",'Не удалось загрузить файл "'+t+'", попробуйте ещё раз',"error"),!1)},onError:function(r){e.html(o).prop("disabled",!1),swal("Произошла ошибка",'Не удалось загрузить файл "'+r+'", попробуйте ещё раз',"error")}})},lemurro.file.download=function(e){lemurro.lightajax.post(!0,pathServerAPI+"file/download/prepare",{fileid:e},function(e){lemurro.lightajax.preloader("hide"),e.hasOwnProperty("errors")?lemurro.showErrors(e.errors):window.open(pathServerAPI+"file/download/run?token="+encodeURI(e.data.token),"Download file")})},lemurro.file.remove=function(e,r){var o=$("."+lemurro.file._classFile+'[data-file-id="'+e+'"]'),t=o.find(".js-name").text();swal({title:"Удаление файла",html:'Вы хотите удалить файл "'+t+'"?',type:"warning",showCancelButton:!0,confirmButtonText:"Да, удалить!",cancelButtonText:"Отмена"}).then(function(a){a.value&&("add"===o.attr("data-file-action")?o.remove():o.attr("data-file-action","remove").hide(),isEmpty(r)||r(e,t))})};