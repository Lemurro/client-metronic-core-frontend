...
var lemurro={start:function(){lemurro.router=new Navigo(location.protocol+"//"+location.host,app.config.router.useHash,app.config.router.hash),lemurro.router.on(app.routes.pages),lemurro.router.notFound(app.routes.notFound),lemurro.router.hooks({after:function(){app.started?lemurro._loadPage():lemurro.init()}}),lemurro.router.resolve()},init:function(){lemurro.sessionID="",lemurro.userinfo={},lemurro.lightajax=new LightAjax({settings:{callbackAlert:function(e,r){Swal.fire(e,r,"error")}},ajax:{beforeSend:function(e,r){/^(HEAD|OPTIONS|TRACE)$/i.test(r.type)||(e.setRequestHeader("X-SESSION-ID",lemurro.sessionID),e.setRequestHeader("X-UTC-OFFSET",moment().utcOffset()))}}}),$.fn.select2.defaults.set("language","ru"),$.fn.select2.defaults.set("placeholder","Выберите из списка"),lemurro._initAuthForm(),lemurro._t7helperDecimal(),lemurro._t7helperLocalTime(),localforage.getItem("sessionID",function(e,r){lemurro.sessionID=r,lemurro.auth.check()}),localforage.getItem("lastSessionID",function(e,r){null!==r&&$("#js-user-return").removeClass("d-none")})},_bindForAll:function(){lemurro.router.updatePageLinks(),lemurro._bindInputmask(),lemurro._bindSelect2(),lemurro._bindTableFilter(),lemurro._showElementsByRoles()},_bindInputmask:function(){$("#js-page").find(".js-mask").each(function(){Inputmask({mask:$(this).attr("data-mask")}).mask(this)})},_bindSelect2:function(){$("#js-page").find(".js-select2").each(function(){$(this).select2()})},_bindTableFilter:function(){$("#js-page").find(".tablefilter").TableFilter()},_initAuthForm:function(){var e=$("#js-auth"),r=$("#js-auth__get-form"),t=$("#js-auth__check-form"),o=app.config.auth.type;app.config.auth.strings.hasOwnProperty(o)||(o="mixed");var s=app.config.auth.strings[o];r.find(".js-auth__auth-id").html(s.getForm.inputLabel),t.find(".js-auth__auth-code").html(s.checkForm.inputLabel),t.find(".js-auth__repeat").html(s.checkForm.repeatMessage),r.find('input[name="auth_id"]').on("keyup",function(e){"Enter"===e.key&&(e.preventDefault(),lemurro.auth.getCode())}).addClass(s.getForm.inputClass),t.find('input[name="auth_code"]').on("keyup",function(e){"Enter"===e.key&&(e.preventDefault(),lemurro.auth.checkCode())}),e.find(".js-code-mask").each(function(){Inputmask({mask:"9999"}).mask(this)}),e.find(".js-phone-mask").each(function(){Inputmask({mask:"+7 (999) 999-99-99"}).mask(this)})},_loadPage:function(){var e=location.protocol+"//"+location.host+"/"+app.page.name+".html";document.title=app.page.title+" | "+app.config.title,$("#kt_header").find(".js-link").each(function(){var e=$(this);e.removeClass(e.attr("data-active-class"))}),$("#js-page").load(e,function(){$("#kt_header").find(".js-link__"+app.page.name).each(function(){var e=$(this);e.addClass(e.attr("data-active-class"))}),lemurro._bindForAll(),isEmpty(app.page.onLoad)||app.page.onLoad()})},_showElementsByRoles:function(){var e,r=$("body");if(lemurro.userinfo.admin)r.find(".js-role").removeClass("d-none");else for(var t in lemurro.userinfo.roles)if(lemurro.userinfo.roles.hasOwnProperty(t))for(var o in r.find(".js-role__"+t+"--any").removeClass("d-none"),lemurro.userinfo.roles[t]){lemurro.userinfo.roles[t].hasOwnProperty(o)&&(e=lemurro.userinfo.roles[t][o],r.find(".js-role__"+t+"--"+e).removeClass("d-none"))}},_t7helperDecimal:function(){Template7.registerHelper("lemurrodecimal",function(e,r){return lemurro.helper.decimal(e,r).toFixed(2)})},_t7helperLocalTime:function(){Template7.registerHelper("lemurrolocaltime",function(e,r){return lemurro.helper.localTime(e,r)})},authScreen:function(e){var r=$("#js-auth");"show"===e?(document.title=app.config.title,$("#js-auth__get-form").show(),$("#js-auth__check-form").hide(),r.find('input[type="text"]').val(""),r.modal({backdrop:"static",keyboard:!1})):r.modal("hide")},hasErrors:function(e){return e.hasOwnProperty("errors")},showErrors:function(e){if(1===e.length&&"401 Unauthorized"===e[0].status)lemurro.authScreen("show");else if(1===e.length&&"403 Forbidden"===e[0].status){var r=!0;e[0].hasOwnProperty("meta")&&e[0].meta.hasOwnProperty("redirect")&&(r=e[0].meta.redirect),r?lemurro.router.navigate("/403"):lemurro._showError(e[0].code,e[0].title)}else for(var t in e)lemurro._showError(e[t].code,e[t].title)},_showError:function(e,r){var t="Неизвестная ошибка",o="error";switch(e){case"danger":o="error",t="Критическая ошибка";break;case"warning":o="warning",t="Внимание!";break;case"info":o="info",t="Информация"}Swal.fire(t,r,o)},auth:{}};lemurro.auth._timerID=null,lemurro.auth._geoip={},lemurro.auth._getGeoIP=function(e){var r=1;jQuery.ajax("https://api.sypexgeo.net",{method:"GET",data:{},success:function(e){lemurro.auth._geoip=e},complete:function(){r=0},error:function(){}});var t=setInterval(function(){0===r&&(clearInterval(t),"function"==typeof e&&e())},500)},lemurro.auth._getUser=function(){lemurro.lightajax.get(!1,pathServerAPI+"user",{},function(e){lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):(lemurro.userinfo=e.data,lemurro.auth._success())})},lemurro.auth._runTimer=function(){null!==lemurro.auth._timerID&&clearInterval(lemurro.auth._timerID),lemurro.auth._timerID=setInterval(function(){var e=$("#js-auth__check-form"),r=e.find(".js-timer__count"),t=parseInt(r.text(),10);0<t?r.text(--t):(clearInterval(lemurro.auth._timerID),e.find(".js-timer").hide(),e.find(".js-resend").show())},1e3)},lemurro.auth._success=function(){$(".js-user__auth-id").text(lemurro.userinfo.auth_id),app.started=!0,$("#js-preloader-overlay").hide(),app.init(lemurro._loadPage)},lemurro.auth.check=function(){lemurro.lightajax.get(!0,pathServerAPI+"auth/check",{},function(e){lemurro.hasErrors(e)?(lemurro.lightajax.preloader("hide"),lemurro.showErrors(e.errors)):lemurro.auth._getUser()})},lemurro.auth.checkCode=function(){var e,r=$("#js-auth__get-form").find('input[name="auth_id"]').val(),t=$("#js-auth__check-form").find('input[name="auth_code"]').val();isEmpty(r)?Swal.fire("Внимание!","Необходимо указать логин","warning"):isEmpty(t)?Swal.fire("Внимание!","Необходимо указать код для входа","warning"):(e=bowser.getParser(window.navigator.userAgent),lemurro.lightajax.post(!0,pathServerAPI+"auth/code",{auth_id:r,auth_code:t,device_info:{uuid:"WebApp",platform:e.parsedResult.os.name,version:e.parsedResult.os.version,manufacturer:e.parsedResult.browser.name,model:e.parsedResult.browser.version},geoip:lemurro.auth._geoip},function(e){lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?($("#js-auth__check-form").find('input[name="auth_code"]').val(""),lemurro.showErrors(e.errors)):localforage.setItem("sessionID",e.data.session,function(){lemurro.sessionID=e.data.session,lemurro.authScreen("hide"),lemurro.auth.check()})}))},lemurro.auth.getCode=function(){var e=$("#js-auth__get-form").find('input[name="auth_id"]').val();isEmpty(e)?Swal.fire("Внимание!","Необходимо указать логин","warning"):lemurro.auth._getGeoIP(function(){lemurro.lightajax.get(!0,pathServerAPI+"auth/code",{auth_id:e,ip:lemurro.auth._geoip.hasOwnProperty("ip")?lemurro.auth._geoip.ip:""},function(e){var r;lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):(r=$("#js-auth__check-form"),e.data.hasOwnProperty("message")&&r.find('input[name="auth_code"]').val(e.data.message),r.find(".js-timer").show(),r.find(".js-timer__count").text("60"),r.find(".js-resend").hide(),lemurro.auth._runTimer(),$("#js-auth__get-form").hide(),r.show())})})},lemurro.auth.logout=function(){lemurro.helper.showConfirm("Выход","Вы действительно хотите выйти из системы?","Да","Нет",null,null,function(){$(".js-user-data").html('<i class="fas fa-spinner fa-pulse"></i>'),localforage.clear(),lemurro.sessionID="",lemurro.authScreen("show")},null)},lemurro.helper={},lemurro.helper.clearFields=function(e){e.find('input[type="text"],input[type="password"],input[type="email"],input[type="number"],input[type="tel"],input[type="url"],input[type="date"],input[type="time"]').val(""),e.find("textarea").val(""),e.find("select").each(function(){$(this).val(null).trigger("change")}),e.find('input[type="checkbox"]').each(function(){$(this).prop("checked",!1)}),e.find('input[type="radio"]').each(function(){$(this).prop("checked",!1)})},lemurro.helper.clearString=function(e){return e.length<13?e:e.split("").join("")},lemurro.helper.decimal=function(e,r){return isEmpty(e)?0:("number"==typeof r&&!isNaN(r)||(r=2),"number"!=typeof e&&(e=(e=e.replace(/ /g,"")).replace(/,/g,"."),e=parseFloat(e),isNaN(e))?0:-1===r?e:parseFloat(e.toFixed(r)))},lemurro.helper.initBootstrapConfirmation=function(e,r){void 0===r&&(r={});var t=Object.assign({title:"Вы уверены?",singleton:!0,popout:!0,rootSelector:"[data-toggle=confirmation]",btnOkLabel:"Да",btnOkClass:"btn btn-sm btn-success",btnCancelLabel:"Нет",btnCancelClass:"btn btn-sm btn-danger"},r);e.find(t.rootSelector).confirmation(t)},lemurro.helper.isRole=function(t,o,s,a){var i=setInterval(function(){if(lemurro.hasOwnProperty("userinfo"))if(clearInterval(i),lemurro.userinfo.admin)"function"==typeof s&&s();else{var e,r=!0;if(lemurro.userinfo.roles.hasOwnProperty(t))for(e in lemurro.userinfo.roles[t])lemurro.userinfo.roles[t][e]===o&&(r=!1,"function"==typeof s&&s());r&&"function"==typeof a&&a()}},500)},lemurro.helper.localTime=function(e,r){return isEmpty(e)||isEmpty(r)?e:moment.utc(e).local().format(r)},lemurro.helper.showConfirm=function(e,r,t,o,s,a,i,l){Swal.fire({title:e,html:r,type:"question",buttonsStyling:!1,focusConfirm:!1,allowOutsideClick:!1,allowEscapeKey:!1,allowEnterKey:!1,showCancelButton:!0,confirmButtonText:t,cancelButtonText:o,confirmButtonClass:"btn btn-success",cancelButtonClass:"btn btn-danger",onOpen:s,preConfirm:a}).then(function(e){e.value?"function"==typeof i&&i():"function"==typeof l&&l()})},lemurro.tabs={},lemurro.tabs.getTabTitle=function(e){var r=$("#js-tpl-tabtitle__"+e);return 0===r.length?"undefined":r.html()},lemurro.tabs.showTab=function(e){var r=$("#js-tabs__links"),t=$("#js-tabs__contents");r.find(".nav-link").removeClass("active show"),t.children(".tab-pane").removeClass("active show"),r.find('a[data-target="#'+e+'"]').addClass("active show"),t.find("#"+e).addClass("active show")},lemurro.tabs.tabInsertEdit=function(e,r,t){var o=$("#js-tabs__links"),s=$("#js-tabs__contents");isEmpty(r)&&(r="tab-form"),isEmpty(t)&&(t="tab-list"),"show"===e?(o.find('a[data-target="#'+r+'"]').parent().show(),s.find("#"+r).addClass("active show"),lemurro.tabs.showTab(r)):(o.find('a[data-target="#'+r+'"]').parent().hide(),s.find("#"+r).removeClass("active show"),lemurro.tabs.showTab(t))},lemurro.guide={},lemurro.guide.init=function(e,r){lemurro.guide._name=e,lemurro.guide._class=r,lemurro.guide._templates={},lemurro.guide._load()},lemurro.guide._getData=function(){lemurro.lightajax.get(!0,pathServerAPI+"guide/"+lemurro.guide._name,{},function(e){if(lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e))lemurro.showErrors(e.errors);else{if($("#js-guide__loader").hide(),0===e.data.count)$("#js-guide__empty").show();else{var r=$("#js-guide__items"),t="";for(var o in e.data.items)e.data.items.hasOwnProperty(o)&&(t+=lemurro.guide._templates.item(e.data.items[o]));r.html(t),$("#js-guide__list").show(),lemurro.helper.initBootstrapConfirmation(r,null)}!isEmpty(lemurro.guide._class)&&window.hasOwnProperty(lemurro.guide._class)&&window[lemurro.guide._class].hasOwnProperty("init")&&window[lemurro.guide._class].init()}})},lemurro.guide._load=function(){var e=$("#js-page"),r=location.protocol+"//"+location.host+"/guide_"+lemurro.guide._name+".html";e.find(".js-guide__title").html(app.page.title),e.find(".js-guide-link").each(function(){var e=$(this);e.removeClass(e.attr("data-active-class"))}),e.find(".js-guide__content").load(r,function(){e.find(".js-guide-link__"+lemurro.guide._name).each(function(){var e=$(this);e.addClass(e.attr("data-active-class"))}),lemurro.guide._templates={item:Template7.compile($("#js-tpl-guide__item").html())},lemurro._bindForAll(),lemurro.guide._getData()})},lemurro.guide.edit=function(t,o){lemurro.lightajax.get(!0,pathServerAPI+"guide/"+lemurro.guide._name+"/"+t,{},function(e){var r;lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):((r=$("#js-guide-form")).attr("data-id",t),r.find(".js-title").text("Редактирование записи"),$("#js-guide__button-insert").hide(),$("#js-guide__button-save").show(),$("#js-tab-form-button").html(lemurro.tabs.getTabTitle("edit")),lemurro.tabs.tabInsertEdit("show"),"function"==typeof o&&o(e))})},lemurro.guide.insert=function(e,o){lemurro.lightajax.post(!0,pathServerAPI+"guide/"+lemurro.guide._name,{json:JSON.stringify(e)},function(e){var r,t;lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):"function"==typeof o?o(e):((r=$("#js-guide__items")).prepend(lemurro.guide._templates.item(e.data)),t=r.find('tr[data-item-id="'+e.data.id+'"]'),lemurro.helper.initBootstrapConfirmation(t,null),$("#js-guide__empty").hide(),$("#js-guide__list").show(),lemurro.tabs.tabInsertEdit("hide"))})},lemurro.guide.remove=function(e,t){lemurro.lightajax.post(!0,pathServerAPI+"guide/"+lemurro.guide._name+"/"+e+"/remove",{},function(e){var r;lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):"function"==typeof t?t(e):((r=$("#js-guide__items")).find('tr[data-item-id="'+e.data.id+'"]').remove(),0===r.find("tr").length&&($("#js-guide__empty").show(),$("#js-guide__list").hide()),Swal.fire("Выполнено","Запись успешно удалена","success"))})},lemurro.guide.save=function(e,o){lemurro.lightajax.post(!0,pathServerAPI+"guide/"+lemurro.guide._name+"/"+e.id,{json:JSON.stringify(e)},function(e){var r,t;lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):"function"==typeof o?o(e):(r=$(lemurro.guide._templates.item(e.data)),(t=$("#js-guide__items").find('tr[data-item-id="'+e.data.id+'"]')).html(r.html()),lemurro.helper.initBootstrapConfirmation(t,null),lemurro.tabs.tabInsertEdit("hide"),Swal.fire("Выполнено","Запись успешно изменена","success"))})},lemurro.guide.showInsertForm=function(e){var r=$("#js-guide-form");r.attr("data-id","0"),r.find(".js-title").text("Добавление записи"),lemurro.helper.clearFields(r),$("#js-guide__button-insert").show(),$("#js-guide__button-save").hide(),$("#js-tab-form-button").html(lemurro.tabs.getTabTitle("add")),lemurro.tabs.tabInsertEdit("show"),"function"==typeof e&&e()},lemurro.users={},lemurro.users.init=function(){lemurro.users._t7helperAccessSets(),lemurro.users._templates={roles:Template7.compile($("#js-tpl-user__roles").html()),accessSetsItem:Template7.compile($("#js-tpl-access-sets__item").html()),accessSetsRoles:Template7.compile($("#js-tpl-access-sets__roles").html())},lemurro.users._initRoles(),lemurro.users._initEmailField(),users.init(),lemurro.accessSets.getData()},lemurro.users._initEmailField=function(){var e=$("#js-user-form"),r=e.find('input[name="auth_id"]'),t=e.find('input[name="email"]');"email"===app.config.auth.type?(t.prop("readonly",!0),r.on("input",function(){t.val(r.val())})):t.prop("readonly",!1)},lemurro.users._initRoles=function(){var e=$("#js-user__roles"),r=app.config.userRoles,t={};for(var o in r.list)if(r.list.hasOwnProperty(o)){var s,a,i=r.list[o],l=[],n=i.title.replace(/"/g,"");for(var u in t.hasOwnProperty(n)||(t[n]=[]),i.access){i.access.hasOwnProperty(u)&&(s=i.access[u],a=r.guideAccess.hasOwnProperty(s)?r.guideAccess[s]:"!unknown",t[n].push({roleName:i.name,accessCode:s,accessName:a.replace(/"/g,"")}),l.push({code:s,name:a}))}e.append(lemurro.users._templates.roles({roleName:i.name,roleTitle:i.title,access:l}))}lemurro.users._setFilterListRoles(t),$("#js-access-sets__roles").html(e.html())},lemurro.users._setFilterListRoles=function(r){var e="",t={};function o(e,r){var t=e.accessName.toUpperCase(),o=r.accessName.toUpperCase(),s=0;return o<t?s=1:t<o&&(s=-1),s}for(var s in Object.keys(r).sort().forEach(function(e){t[e]=r[e]}),t)if(t.hasOwnProperty(s)){var a=t[s];for(var i in e+='<optgroup label="'+s+'">',a.sort(o),a)a.hasOwnProperty(i)&&(e+='<option value="'+a[i].roleName+"|"+a[i].accessCode+'">'+s+": "+a[i].accessName+"</option>");e+="</optgroup>"}$("#js-page").find(".js-filter").find('select[name="lemurro_roles"]').append(e)},lemurro.users._t7helperAccessSets=function(){Template7.registerHelper("lemurroaccesssets",function(e){var r,t=[],o={};for(var s in app.config.userRoles.list){app.config.userRoles.list.hasOwnProperty(s)&&(o[(r=app.config.userRoles.list[s]).name]=r.title)}for(var a in e)if(e.hasOwnProperty(a)){var i=e[a],l=[];for(var n in i)i.hasOwnProperty(n)&&app.config.userRoles.guideAccess.hasOwnProperty(i[n])&&l.push(app.config.userRoles.guideAccess[i[n]]);t.push({title:o.hasOwnProperty(a)?o[a]:"!неизвестно>>"+a,access:l})}return lemurro.users._templates.accessSetsRoles(t)})},lemurro.users.applyFilter=function(){var r=$("#js-page"),t={};r.find(".js-filter").find(".js-filter__element").each(function(){var e=$(this),r=e.attr("name");t[r]=e.val()}),r.find(".js-message__notfound").hide(),lemurro.lightajax.post(!0,pathServerAPI+"users/filter",{json:JSON.stringify(t)},function(e){lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):(lemurro.users.showData(e.data),0===e.data.count&&r.find(".js-message__notfound").show())})},lemurro.users.clearFilter=function(){var e=$("#js-page").find(".js-filter");e.find("select").val("all").trigger("change"),e.find('input[type="text"]').val("")},lemurro.users.edit=function(t,o){lemurro.lightajax.get(!0,pathServerAPI+"users/"+t,{},function(e){var r;lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):((r=$("#js-user-form")).attr("data-id",t),r.find(".js-title").text("Редактирование пользователя"),"1"===t?(r.find(".js-user-id-1").prop("disabled",!0),Swal.fire("Внимание!","У данного пользователя некоторые поля запрещены к изменению","warning")):r.find(".js-user-id-1").prop("disabled",!1),$("#js-user__access-sets").find("select").val(null),$("#js-user__button-insert").hide(),$("#js-user__button-save").show(),$("#js-tab-form-button").html(lemurro.tabs.getTabTitle("edit")),lemurro.tabs.tabInsertEdit("show"),"function"==typeof o&&o(e))})},lemurro.users.getRoles=function(e){var t={};return e.find(".js-role:checked").each(function(){var e=$(this),r=e.attr("data-role");"admin"===r?t.admin=!0:(t.hasOwnProperty(r)||(t[r]=[]),t[r].push(e.attr("data-access")))}),t.hasOwnProperty("admin")&&(t={admin:!0}),t},lemurro.users.insert=function(e,r){lemurro.lightajax.post(!0,pathServerAPI+"users",{json:JSON.stringify(e)},function(e){lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):"function"==typeof r&&r(e)})},lemurro.users.lock=function(e,o){"1"===e?Swal.fire("Внимание!","Блокировка пользователя с id=1 запрещена","warning"):lemurro.lightajax.post(!0,pathServerAPI+"users/"+e+"/lock",{},function(e){var r,t;lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):(r=$(users.templates.item(e.data)),(t=$("#js-users__items").find('tr[data-item-id="'+e.data.id+'"]')).html(r.html()),lemurro.helper.initBootstrapConfirmation(t,null),"function"==typeof o&&o(e))})},lemurro.users.loginByUser=function(e){"1"===e?Swal.fire("Внимание!","Входить под пользователем с id=1 запрещено","warning"):lemurro.lightajax.post(!0,pathServerAPI+"users/login_by_user",{user_id:e},function(e){lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):localforage.setItem("lastSessionID",lemurro.sessionID,function(){localforage.setItem("sessionID",e.data.session,function(){location.replace(location.origin)})})})},lemurro.users.remove=function(e,r){"1"===e?Swal.fire("Внимание!","Пользователь с id=1 не может быть удалён","warning"):lemurro.lightajax.post(!0,pathServerAPI+"users/"+e+"/remove",{},function(e){lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):"function"==typeof r&&r(e)})},lemurro.users.return=function(){localforage.getItem("lastSessionID",function(e,r){var t=r;null!==t?Swal.fire({title:"Вернуться обратно?",html:"",type:"warning",showCancelButton:!0,confirmButtonText:"Да",cancelButtonText:"Нет"}).then(function(e){e.value&&localforage.removeItem("lastSessionID",function(){localforage.setItem("sessionID",t,function(){location.reload()})})}):Swal.fire("Ошибка","Прошлая сессия отсутствует","error")})},lemurro.users.save=function(e,r){lemurro.lightajax.post(!0,pathServerAPI+"users/"+e.id,{json:JSON.stringify(e)},function(e){lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):"function"==typeof r&&r(e)})},lemurro.users.setRoles=function(e,r){for(var t in e.find(".js-role").prop("checked",!1),r)if("admin"===t)e.find('.js-role[data-role="admin"]').prop("checked",!0);else for(var o in r[t])r[t].hasOwnProperty(o)&&e.find('.js-role[data-role="'+t+'"][data-access="'+r[t][o]+'"]').prop("checked",!0)},lemurro.users.showData=function(e){var t=$("#js-users__items"),r="";for(var o in e.items)e.items.hasOwnProperty(o)&&(r+=users.templates.item(e.items[o]));t.html(r),localforage.getItem("lastSessionID",function(e,r){null!==r&&t.find(".js-login-by-user").hide()}),lemurro.helper.initBootstrapConfirmation(t,null),users.hasOwnProperty("afterShowData")&&notEmpty(users.afterShowData)&&users.afterShowData(e)},lemurro.users.showInsertForm=function(e){var r=$("#js-user-form");r.attr("data-id","0"),r.find(".js-title").text("Добавление пользователя"),lemurro.helper.clearFields(r),r.find(".js-user-id-1").prop("disabled",!1),$("#js-user__access-sets").find("select").val(null),$("#js-user__button-insert").show(),$("#js-user__button-save").hide(),$("#js-tab-form-button").html(lemurro.tabs.getTabTitle("add")),lemurro.tabs.tabInsertEdit("show"),"function"==typeof e&&e()},lemurro.users.unlock=function(e,o){lemurro.lightajax.post(!0,pathServerAPI+"users/"+e+"/unlock",{},function(e){var r,t;lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):(r=$(users.templates.item(e.data)),(t=$("#js-users__items").find('tr[data-item-id="'+e.data.id+'"]')).html(r.html()),lemurro.helper.initBootstrapConfirmation(t,null),"function"==typeof o&&o(e))})},lemurro.accessSets={},lemurro.accessSets._buildSelect=function(){var e=$("#js-user__access-sets"),o="";$("#js-access-sets__items").find("tr").each(function(){var e=$(this),r=e.attr("data-item-id"),t=e.find(".name").text();o+='<option value="'+r+'">'+t+"</option>"}),e.find("select").html(o),notEmpty(o)?e.show():e.hide()},lemurro.accessSets._collectData=function(){var e=$("#js-access-sets-form");return e.valid()?{id:e.attr("data-id"),name:e.find('input[name="name"]').val(),roles:lemurro.users.getRoles(e)}:(Swal.fire("Внимание!","Заполните все поля, помеченные красным","warning"),{})},lemurro.accessSets.apply=function(){var r=$("#js-user__access-sets").find("select"),e=r.val();isEmpty(e)||lemurro.lightajax.get(!0,pathServerAPI+"access_sets/"+e,{},function(e){lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):(lemurro.users.setRoles($("#js-user-form"),e.data.roles),r.val(null),Swal.fire("Выполнено",'Успешно применён набор "'+e.data.name+'"',"success"))})},lemurro.accessSets.closeForm=function(){$("#js-access-sets-form").hide(),$("#js-access-sets__button-add").show()},lemurro.accessSets.edit=function(t){lemurro.lightajax.get(!0,pathServerAPI+"access_sets/"+t,{},function(e){var r;lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):((r=$("#js-access-sets-form")).attr("data-id",t),r.find(".js-title").text("Редактирование набора"),r.find('input[name="name"]').val(e.data.name),$("#js-access-sets__button-insert").hide(),$("#js-access-sets__button-save").show(),$("#js-access-sets__button-add").hide(),lemurro.users.setRoles(r,e.data.roles),r.show())})},lemurro.accessSets.getData=function(){lemurro.lightajax.get(!1,pathServerAPI+"access_sets",{},function(e){if(lemurro.hasErrors(e))lemurro.showErrors(e.errors);else{var r,t=$("#js-access-sets__items"),o="";for(var s in e.data.items){e.data.items.hasOwnProperty(s)&&(r=e.data.items[s],o+=lemurro.users._templates.accessSetsItem(r))}t.html(o),lemurro.helper.initBootstrapConfirmation(t,null),lemurro.accessSets._buildSelect()}})},lemurro.accessSets.insert=function(){var e=lemurro.accessSets._collectData();0<Object.keys(e).length&&lemurro.lightajax.post(!0,pathServerAPI+"access_sets",{json:JSON.stringify(e)},function(e){var r,t;lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):((r=$("#js-access-sets__items")).prepend(lemurro.users._templates.accessSetsItem(e.data)),t=r.find('tr[data-item-id="'+e.data.id+'"]'),lemurro.helper.initBootstrapConfirmation(t,null),lemurro.accessSets._buildSelect(),$("#js-access-sets-form").hide(),$("#js-access-sets__button-add").show())})},lemurro.accessSets.remove=function(e){lemurro.lightajax.post(!0,pathServerAPI+"access_sets/"+e+"/remove",{},function(e){lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):($("#js-access-sets__items").find('tr[data-item-id="'+e.data.id+'"]').remove(),lemurro.accessSets._buildSelect(),Swal.fire("Выполнено","Запись успешно удалена","success"))})},lemurro.accessSets.save=function(){var e=lemurro.accessSets._collectData();0<Object.keys(e).length&&lemurro.lightajax.post(!0,pathServerAPI+"access_sets/"+e.id,{json:JSON.stringify(e)},function(e){var r,t;lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):(r=$(lemurro.users._templates.accessSetsItem(e.data)),(t=$("#js-access-sets__items").find('tr[data-item-id="'+e.data.id+'"]')).html(r.html()),lemurro.helper.initBootstrapConfirmation(t,null),lemurro.accessSets._buildSelect(),$("#js-access-sets-form").hide(),$("#js-access-sets__button-add").show(),Swal.fire("Выполнено","Запись успешно изменена","success"))})},lemurro.accessSets.showInsertForm=function(){var e=$("#js-access-sets-form");e.attr("data-id","0"),e.find(".js-title").text("Добавление набора"),lemurro.helper.clearFields(e),$("#js-access-sets__button-insert").show(),$("#js-access-sets__button-save").hide(),$("#js-access-sets__button-add").hide(),e.show()},lemurro.authKeys={},lemurro.authKeys.getData=function(){var e=$("#js-auth-keys"),r=e.find(".js-auth-keys__message"),t=e.find(".js-auth-keys__table"),o=e.find(".js-auth-keys__items");r.hide(),t.hide(),o.html(""),lemurro.lightajax.get(!0,pathServerAPI+"auth/keys",{},function(e){lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):0<e.data.length?(lemurro.authKeys.hasOwnProperty("_template")||(lemurro.authKeys._template=Template7.compile($("#js-tpl-auth-keys__items").html())),t.show(),o.html(lemurro.authKeys._template(e.data))):r.show()})},lemurro.file={},lemurro.file.init=function(e){lemurro.file._config(),isEmpty(e)?lemurro.file._classFile="js-files__file":lemurro.file._classFile=e},lemurro.file._config=function(){ss.uploadSetup({url:pathServerAPI+"file/upload",name:"uploadfile",hoverClass:"hover",focusClass:"focus",responseType:"json",multiple:!0,multipleSelect:!0,customHeaders:{"X-SESSION-ID":lemurro.sessionID,"X-UTC-OFFSET":moment().utcOffset()}})},lemurro.file.bindUpload=function(t,o,e){var s=t.html();isEmpty(e)&&(e={});var r=$.extend({button:t,onSubmit:function(){t.html('<i class="fas fa-spinner fa-pulse"></i> Загрузка...').prop("disabled",!0)},onComplete:function(e,r){if(t.html(s).prop("disabled",!1),!r)return Swal.fire("Произошла ошибка",'Не удалось загрузить файл "'+e+'", попробуйте ещё раз',"error"),!1;lemurro.hasErrors(r)?lemurro.showErrors(r.errors):"function"==typeof o?o(r.data.id,"add",e,t):Swal.fire("Выполнено","Файл <strong>"+e+"</strong> успешно загружен","success")},onError:function(e){t.html(s).prop("disabled",!1),Swal.fire("Произошла ошибка",'Не удалось загрузить файл "'+e+'", попробуйте ещё раз',"error")}},e);new ss.SimpleUpload(r)},lemurro.file.download=function(e,r){lemurro.lightajax.post(!0,pathServerAPI+"file/download/prepare",{fileid:e,filename:r},function(e){lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):window.open(pathServerAPI+"file/download/run?token="+encodeURI(e.data.token),"Download file")})},lemurro.file.remove=function(r,t){var o=$("."+lemurro.file._classFile+'[data-file-id="'+r+'"]'),s=o.find(".js-name").text();Swal.fire({title:"Удаление файла",html:'Вы хотите удалить файл "'+s+'"?',type:"warning",showCancelButton:!0,confirmButtonText:"Да, удалить!",cancelButtonText:"Отмена"}).then(function(e){e.value&&("add"===o.attr("data-file-action")?o.remove():o.attr("data-file-action","remove").hide(),isEmpty(t)||t(r,s))})},lemurro.profile={},lemurro.profile.init=function(){Template7.global={sessionID:lemurro.sessionID},lemurro.profile.templates={info:Template7.compile($("#js-tpl-profile__info").html()),sessions:Template7.compile($("#js-tpl-profile__sessions").html())},lemurro.profile.getData()},lemurro.profile.getData=function(){lemurro.lightajax.get(!0,pathServerAPI+"profile",{},function(e){lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):lemurro.profile.showData(e.data)})},lemurro.profile.resetSession=function(r){lemurro.lightajax.post(!0,pathServerAPI+"profile/session/reset",{session:r},function(e){lemurro.lightajax.preloader("hide"),lemurro.hasErrors(e)?lemurro.showErrors(e.errors):$("#js-page").find(".js-profile__sessions").find('div[data-id="'+r+'"]').remove()})},lemurro.profile.showData=function(e){var r=$("#js-page");r.find(".js-profile__info").html(lemurro.profile.templates.info(lemurro.userinfo)),r.find(".js-profile__sessions").html(lemurro.profile.templates.sessions(e.sessions)),lemurro.helper.initBootstrapConfirmation(r,null),profile.hasOwnProperty("_afterShowData")&&"function"==typeof profile._afterShowData&&profile._afterShowData(e)};